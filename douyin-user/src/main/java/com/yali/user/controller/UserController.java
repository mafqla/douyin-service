...
import com.yali.user.constants.UserErrorInfo;
...
public class UserController {
    ...
    public UserDTO queryUserById(
        ...
        return BeanUtils.copyBean(userDetail, UserDTO.class);
    }
    ...
    public LoginUserDTO queryUserDetail(
            @Valid @RequestBody LoginFormDTO loginDTO) {
        return userService.queryUserDetail(loginDTO);
    }

    @ApiOperation("用户注册通过手机号码")
    @PostMapping("/register")
    public Map<String, Long> registerByPhone(@Valid @RequestBody RegisterFormDTO registerFormDTO) {
        return userService.addUserByPhone(registerFormDTO);
    }
    ...
    public List<UserDTO> queryUserByIds(
        ...
        // 2.转换
        return BeanUtils.copyList(list, UserDTO.class);
    }
