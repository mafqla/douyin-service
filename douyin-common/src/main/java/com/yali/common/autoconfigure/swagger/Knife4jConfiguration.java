package com.yali.common.autoconfigure.swagger;

import cn.hutool.core.convert.ConverterRegistry;
import com.fasterxml.classmate.TypeResolver;
import com.yali.common.domain.R;
import com.yali.common.utils.TjTemporalConverter;
...
@Configuration
@ConditionalOnProperty(prefix = "dy.swagger", name = "enable", havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @Primary
    @ConditionalOnProperty(prefix = "dy.swagger", name = "enableResponseWrap", havingValue = "true")
