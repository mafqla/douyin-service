package com.yali.auth.common.constants;
...
public interface AuthErrorInfo {
    ...
    interface Code {
        ...
        // 角色code已存在
        int ROLE_CODE_EXISTS_CODE = 2001;
        // 角色名称已存在
        int ROLE_NAME_EXISTS_CODE = 2002;
        // 角色id存在
        int ROLE_ID_EXISTS_CODE = 2003;
        // 角色id不存在
        int ROLE_NOT_FOUND_CODE = 2004;
    }
}