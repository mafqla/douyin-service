...
import com.yali.media.storage.tencent.TencentFileStorage;
import com.yali.media.storage.tencent.TencentMediaStorage;
...
public class TencentConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "dy.platform", name = "media", havingValue = "TENCENT")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "dy.platform", name = "file", havingValue = "TENCENT")
