...
@Slf4j
public class MinioMediaStorage implements IMinioStorage {
    private final MinioClient minioMediaClient;
    private final String bucketName;

    public MinioMediaStorage(MinioClient minioMediaClient, MinioProperties properties) {
        this.minioMediaClient = minioMediaClient;
        this.bucketName = properties.getMediaBucket();
    }
    ...
    public String uploadFile(String key, InputStream inputStream, long contentLength, String contentType) {
        ...
        try {
            //2.上传文件
            ObjectWriteResponse upload = minioMediaClient.putObject(PutObjectArgs.builder()
                    .bucket(bucketName)
                    .object(key)
    ...
    public InputStream downloadFile(String key) {
        ...
        try {
            return minioMediaClient.getObject(
                    GetObjectArgs
                            .builder()
                            .bucket(bucketName)
                            .object(key)
    ...
    public void deleteFiles(List<String> keys) {
        ...
        try {
            ...
            //3. 删除
            Iterable<Result<DeleteError>> results = minioMediaClient.removeObjects(
    ...
    public String generateUrl(String key) {
        ...
        try {
            //2. 生成url
            String url = minioMediaClient.getPresignedObjectUrl(
