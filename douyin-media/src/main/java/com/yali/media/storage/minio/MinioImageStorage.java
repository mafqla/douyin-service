...
@Slf4j
public class MinioImageStorage implements IMinioStorage {
    private final MinioClient minioImageClient;
    private final String bucketName;

    public MinioImageStorage(MinioClient minioImageClient, MinioProperties properties) {
        this.minioImageClient = minioImageClient;
        this.bucketName = properties.getImageBucket();
    }
    ...
    public String uploadFile(String key, InputStream inputStream, long contentLength, String contentType) {
        ...
        try {
            //2.上传文件
            ObjectWriteResponse upload = minioImageClient.putObject(PutObjectArgs.builder()
                    .bucket(bucketName)
                    .object(key)
    ...
    public InputStream downloadFile(String key) {
        ...
        try {
            return minioImageClient.getObject(
                    GetObjectArgs
                            .builder()
                            .bucket(bucketName)
                            .object(key)
    ...
    public void deleteFiles(List<String> keys) {
        ...
        try {
            ...
            //3. 删除
            Iterable<Result<DeleteError>> results = minioImageClient.removeObjects(
    ...
    public String generateUrl(String key) {
        ...
        try {
            //2. 生成url
            String url = minioImageClient.getPresignedObjectUrl(
