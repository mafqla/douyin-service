<template>
  <div class="video-item">
    <a href="#" class="video-item-link">
      <div class="video-item-content">
        <div class="video-item-img">
          <img
            src="//p3-pc-sign.douyinpic.com/tos-cn-p-0015/64584021e24140da9e3589f43566dc1e_1679019376~tplv-dy-cropcenter:323:430.jpeg?biz_tag=pcweb_cover&amp;from=3213915784&amp;s=PackSourceEnum_FAVORITE&amp;sc=cover&amp;se=true&amp;sh=323_430&amp;x-expires=1995112800&amp;x-signature=JFm4YLlIG6GVLFfGaocqU2VhsH0%3D"
            alt="熟人ㅤㅤ：世界这么宽广 别走进悲伤的墙角. #Bulletproof#希望你我热烈自由且勇敢"
            class=""
          />
        </div>
      ...
      <p class="video-title">
        世界这么宽广 别走进悲伤的墙角. #Bulletproof#希望你我热烈自由且勇敢
      </p>
    </a>
  </div>
</template>
